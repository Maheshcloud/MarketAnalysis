resource "aws_cloudwatch_event_rule" "start_instance_rule" {
  ...
  schedule_expression = "cron(0 14 ? * MON-FRI *)" # Example: 14:00 UTC (2 PM UTC) Monday-Friday. Adjust to your market open time in UTC.
}
...
resource "aws_cloudwatch_event_rule" "terminate_instance_rule" {
  ...
  schedule_expression = "cron(0 21 ? * MON-FRI *)" # Example: 21:00 UTC (9 PM UTC) Monday-Friday. Adjust to your market close time in UTC.
}
